...
<div class="all">
    <div class="lefter">
        <button  style="width: 100%;height: 100%;opacity:-5.7" onclick="window.location.href='/sock/mapJsp'"></button>
        <div class="text">Map Station</div>
    </div>
    ...
    <div class="center">
        <button class="explainer" onclick="window.location.href='/sock/scheduleJsp'"><span>Menu</span></button>
